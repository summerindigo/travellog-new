...
def post():            ## 일기 저장 버튼 누르면
    id_writer_receive = request.form['id_writer_give']
    id_numbers_receive = request.form['id_numbers_give']
    ...
    today = datetime.now()
    mytime = today.strftime('%Y-%m-%d-%H%M%S') ## 예시 2020-09-01-125956 -> 2020년 9월 1일 12시 59분 56초 인것
